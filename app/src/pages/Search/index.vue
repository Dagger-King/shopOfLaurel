            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{ active: isOne }" @click="changeOrder('1')">
                  <a>综合<i v-show="isOne" :class="checkUp"></i></a>
                </li>
                <li :class="{ active: isTwo }" @click="changeOrder('2')">
                  <a>价格<i v-show="isTwo" :class="checkUp"></i></a>
                </li>
              </ul>
            </div>
          </div>
...
export default {
  ...
  computed: {
    ...
    checkUp() {
      if (this.searchParams.order.indexOf("asc") != -1) {
        return "iconfont icon-arrowup";
      } else {
        return "iconfont icon-arrowdown";
      }
    },
  },
  beforeMount() {
  ...
  methods: {
    ...
    attrInfo(id, value, name) {
      // console.log('fu',id,value,name)
      let prop = `${id}:${value}:${name}`;
      // console.log(this.searchParams.props,this.searchParams.props.indexOf(prop))
