  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <!-- <img ref="code" src="http://gmall-h5-api.atguigu.cn/api/user/passport/code" alt="code" @click="getcode"> -->
    ...
    methods:{
      ...
      async userRegister(){
        try {
          ...
          phone&&code&&password==password1&&agree && await this.$store.dispatch('userRegister',{phone,code,password})
